...
// previousSearchButton = document.getElementsByClassName("previous-search");
// previousSearchButton[0].addEventListener("click", function(getWeather){
//     var cityNameInput = previousSearchButton[0].textContent;
